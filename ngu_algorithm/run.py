...
def parse_args():
    ...
    parser.add_argument('--ngu_frequency', type=int, default=5)
    ...
    parser.add_argument('--wandb_entity', type=str, default='ngu_algorithm')
...
algo = NGU_A(algo='ngu', env_class=env_class, env_params={'name':args.env_name}, N=args.N, 
            gamma=args.gamma, lr_theta=args.lr_theta, lr_q=args.lr_q, lr_starts=args.lr_starts, 
            tau=args.tau, policy_frequency=args.policy_frequency, ngu_frequency = args.ngu_frequency,  target_frequency=args.target_frequency, noise=args.noise, 
