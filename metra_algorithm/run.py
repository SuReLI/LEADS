...
import gym 
from metra_algorithm.metra import METRA
...
def parse_args():
    ...
    parser.add_argument('--wandb_entity', type=str, default='metra_algorithm')
...
algo = METRA(algo='metra', env_class=env_class, env_params={'name':args.env_name}, N=args.N, featurize = args.featurize,
