...
def parse_args():
    ...
    parser.add_argument('--featurize', type=lambda x: bool(strtobool(x)), default=False)
    parser.add_argument('--device', type=str, default='cpu')
    parser.add_argument('--n_env', type=int, default=6)
    parser.add_argument('--wandb_project_name', type=str, default='LDS')
    parser.add_argument('--wandb_entity', type=str, default='smm_algorithm')
...
algo = SMM(algo='smm', env_class=env_class, env_params={'name':args.env_name}, N=args.N, 
