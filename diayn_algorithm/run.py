...
def parse_args():
    ...
    parser.add_argument('--env_class', type=str, default='finger')
    parser.add_argument('--env_name', type=str, default='finger')
    ...
    parser.add_argument('--featurize', type=lambda x: bool(strtobool(x)), default=True)
    parser.add_argument('--device', type=str, default='cpu')
    parser.add_argument('--n_env', type=int, default=6)
    parser.add_argument('--wandb_project_name', type=str, default='LDS')
    parser.add_argument('--wandb_entity', type=str, default='diayn_algorithm')
...
algo = DIAYN(algo='diayn', env_class=env_class, env_params={'name':args.env_name}, N=args.N, 
            n_skill=args.n_skill, z_dim=args.n_skill, gamma=args.gamma, lr_theta=args.lr_theta, lr_q=args.lr_q, lr_starts=args.lr_starts, 
            ...
            device=args.device, n_env=args.n_env, wandb_project_name=args.wandb_project_name, wandb_entity=args.wandb_entity, featurize=args.featurize)
algo.train()
